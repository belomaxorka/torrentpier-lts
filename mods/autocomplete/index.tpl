<script type="text/javascript" src="{SITE_URL}mods/autocomplete/jquery-ui.min.js"></script>
<link rel="stylesheet" href="{SITE_URL}mods/autocomplete/jquery-ui.min.css" type="text/css">
<script>
	(function () {
		let config = JSON.parse('{CONFIG}'),
			items = {};
		$.each(config, (id, data) => {
			items[id] = ['INP', data.title, data.attr1, data.attr2];
		});
