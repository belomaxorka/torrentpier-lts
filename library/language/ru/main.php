...
$lang['CLEAR'] = 'Очистить';
$lang['MOVE_TO_TOP'] = 'Подняться наверх';
...
$lang['BOARD_DISABLE'] = 'Извините, на ресурсе ведутся технические работы. Попробуйте зайти позднее. Вход разрешен только администрации ресурса';
$lang['BOARD_DISABLE_CRON'] = 'Форум заблокирован триггером cron-заданий. Пожалуйста, обновите страницу';
...
$lang['PARK_WARNING'] = 'Припарковав аккаунт, вы не сможете пользоваться ресурсом!';
$lang['PARK_PROFILE_STATUS'] = 'Аккаунт припаркован';
$lang['PARK_PROFILE_STATUS_FAQ'] = 'Что такое "Парковка аккаунта"?';
$lang['PARK_ACCOUNT_PARKED'] = 'Доступ к ресурсу ограничен пока аккаунт припаркован. Чтобы начать пользоваться ресурсом снова, отключите парковку в настройках профиля';
...
// Обнуление рейтинга
$lang['BT_NULL_RATIO'] = 'Обнулить рейтинг';
$lang['BT_NULL_RATIO_NONE'] = 'У вас нет рейтинга';
$lang['BT_NULL_RATIO_ALERT'] = "Внимание!\n\nВы уверены что хотите сбросить рейтинг?";
$lang['BT_NULL_RATIO_AGAIN'] = 'Вы уже обнуляли свой рейтинг!';
$lang['BT_NULL_RATIO_NOT_NEEDED'] = 'У вас хороший рейтинг. Обнуление разрешено только при рейтинге меньше чем %f';
